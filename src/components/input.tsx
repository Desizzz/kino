      ...
      <div className="mx-auto w-full">
        <div className="w-full md:w-1/2">
          <form className="flex items-center">
            ...
            <svg onClick={() => PushData(valueInp)} aria-hidden="true" className="w-5 ml-4 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
